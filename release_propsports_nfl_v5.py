...
NFL_DATA_CARDS = '''
        ...
        <div class="endpoint-card"><span class="badge-get">GET</span><div><h4>/nfl/standings</h4><p>Current NFL standings normalized into conference and division groups.</p></div></div>
        ...
        <div class="endpoint-card"><span class="badge-get">GET</span><div><h4>/nfl/team/:id/schedule</h4><p>Team-specific NFL schedule with normalized game state.</p></div></div>
...
INDEX_EP_CARDS = '''
      ...
      <div class="ep-card" data-tags="nfl standings conference division records"><span class="get-b">GET</span><div><div class="ep-path">/nfl/standings</div><div class="ep-desc">Current NFL conference and division standings.</div></div></div>
      ...
      <div class="ep-card" data-tags="nfl team schedule games"><span class="get-b">GET</span><div><div class="ep-path">/nfl/team/:id/schedule</div><div class="ep-desc">Team-specific schedule with normalized game state.</div></div></div>
...
INDEX_SP_ITEMS = '''
        ...
        <div class="sp-item"><span class="sp-badge">GET</span><div><div class="sp-path">/nfl/standings</div><div class="sp-desc">Conference + division standings.</div></div></div>
...
DOC_SECTIONS = '''
    <div class="doc-section" id="nfl-scoreboard">
      ...
      <table class="param-table"><thead><tr><th>Param</th><th>Type</th><th>Required</th><th>Description</th></tr></thead><tbody><tr><td class="pn">date</td><td class="pt">YYYYMMDD</td><td><span class="po">optional</span></td><td>Scoreboard date. Defaults to the current Eastern date.</td></tr><tr><td class="pn">week</td><td class="pt">integer</td><td><span class="po">optional</span></td><td>NFL week. When supplied, week mode takes precedence over date.</td></tr><tr><td class="pn">season_type</td><td class="pt">integer</td><td><span class="po">optional</span></td><td>ESPN season type. Defaults to 2 for regular season.</td></tr></tbody></table>
    </div>

    <div class="doc-section" id="nfl-standings"><h2>GET /nfl/standings</h2><div class="ep-badge"><span class="get-tag">GET</span>/nfl/standings</div><p>Current NFL standings normalized into conference and division groups with team metadata and provider-supplied standings statistics.</p></div>
